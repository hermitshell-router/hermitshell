...
# Verify Traffic page renders with SVG chart
traffic_page_ok() {
    local page
    page=$(vm_exec lan "curl -sk https://10.0.0.1:8443/traffic 2>/dev/null || curl -sk http://10.0.0.1:8080/traffic 2>/dev/null || true")
