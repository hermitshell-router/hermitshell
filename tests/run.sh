...
run_phase "all" \
    "cases/01-wan-connectivity.sh cases/02-lan-dhcp.sh cases/45-dhcpv6-neigh-mac.sh cases/03-lan-internet.sh cases/04-agent-socket.sh cases/05-device-discovery.sh cases/06-bandwidth-tracking.sh cases/10-subnet-assignment.sh cases/18-hostname-capture.sh cases/33-dhcp-hardening.sh cases/07-web-ui.sh cases/21-auth-https.sh cases/38-setup-wizard.sh cases/12-ad-blocking.sh cases/13-dns-redirect.sh cases/23-connection-logging.sh cases/24-dns-query-logging.sh cases/25-log-export-config.sh cases/08-device-quarantine.sh cases/09-device-approval.sh cases/11-device-block.sh cases/15-device-groups.sh cases/16-wireguard-setup.sh cases/17-wireguard-peer-traffic.sh cases/22-backup-restore.sh cases/26-config-key-protection.sh cases/27-runzero-config.sh cases/28-behavioral-analysis.sh cases/44-mac-spoof-defense.sh cases/19-port-forwarding.sh cases/20-dhcp-reservation.sh cases/36-tls-management.sh cases/37-wifi-management.sh cases/39-update-check.sh cases/40-bandwidth-dashboard.sh cases/41-input-validation.sh cases/41-dashboard-stats.sh cases/42-enhanced-logs.sh cases/43-device-presence.sh cases/49-dns-forward-zones.sh cases/50-dns-custom-rules.sh cases/51-dot-doh-bypass.sh cases/14-agent-restart.sh"
